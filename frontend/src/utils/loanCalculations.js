...
export const calculateRemainingDays = (endDate, currentDate = new Date()) => {
    if (!endDate) return 0;
    const end = new Date(endDate);
...
export const calculateSettlementAmount = (remainingLoan = 0, remainingInterest = 0, penalty = 0, documentCharge = 0) => {
    return Number((

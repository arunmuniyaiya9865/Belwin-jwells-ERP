...
const GoldStockReport = () => {
  ...
  const fetchReport = useCallback(async () => {
    try {
      ...
      const response = await api.get('/gold-stocks/report?${queryParams.toString()}');
    ...
    <div className="p-6 h-full flex flex-col space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 shrink-0">
        <div className="bg-gradient-to-br from-emerald-900 to-emerald-950 p-4 rounded-xl border border-emerald-800 flex items-center justify-between shadow-lg">
          <div>
            <p className="text-emerald-200 text-sm font-medium mb-1">Total Articles</p>
        ...
        <div className="bg-gradient-to-br from-emerald-900 to-emerald-950 p-4 rounded-xl border border-emerald-800 flex items-center justify-between shadow-lg">
          <div>
            <p className="text-emerald-200 text-sm font-medium mb-1">Gross Weight (g)</p>
        ...
        <div className="bg-gradient-to-br from-emerald-900 to-emerald-950 p-4 rounded-xl border border-emerald-800 flex items-center justify-between shadow-lg">
          <div>
            <p className="text-emerald-200 text-sm font-medium mb-1">Auction Ready</p>
            <p className="text-2xl font-bold text-white">{summary.auctionReadyArticles}</p>
          </div>
          <div className="p-3 bg-emerald-500/20 rounded-full border border-emerald-400/30">
            <Gavel className="w-6 h-6 text-emerald-300" />
          </div>
        </div>
      </div>
